...
- Captured labels are perspective corrected using OpenCV prior to OCR for better accuracy. When debugging, the warped image is saved and displayed via **Show Crop**.
